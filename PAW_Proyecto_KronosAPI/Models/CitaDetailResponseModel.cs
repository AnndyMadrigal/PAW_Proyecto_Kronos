namespace PAW_Proyecto_KronosAPI.Models
{
    ...
    public class CitaDetailResponseModel
    {
    ...
    public class CitaStatusHistoryResponseModel
    {
        public int id { get; set; }
    ...
    public class CitaDetailFullResponseModel
    {
        public CitaDetailResponseModel? cita { get; set; }
        public List<CitaStatusHistoryResponseModel> historial { get; set; } = new();
    }
}
